...
data = np.genfromtxt('./out_unix_socket_memfd_without_zerocopy')
...
ax1.set_title('Sealed memfd Without Zero-Copy Latency (ns) (10th and 90th percentiles)')
ax1.set_yscale('log')
...
ax2.set_title('Sealed memfd Without Zero-Copy Bandwidth (MiB/s) (10th and 90th percentiles)')
